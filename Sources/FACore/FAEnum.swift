...
public enum FAIcon: String, CaseIterable, CustomStringConvertible {
    ...
    public var label: String {
        switch self {
			...
			case .acquisitionsIncorporated: return "Acquisitions Incorporated"
			case .ad: return "Ad"
			case .addressBook: return "Address Book"
			case .addressCard: return "Address Card"
			case .adjust: return "adjust"
			case .adn: return "App.net"
			...
			case .americanSignLanguageInterpreting: return "American Sign Language Interpreting"
			case .amilia: return "Amilia"
			case .anchor: return "Anchor"
			case .android: return "Android"
			case .angellist: return "AngelList"
			case .angleDoubleDown: return "Angle Double Down"
			case .angleDoubleLeft: return "Angle Double Left"
			case .angleDoubleRight: return "Angle Double Right"
			case .angleDoubleUp: return "Angle Double Up"
			...
			case .angrycreative: return "Angry Creative"
			case .angular: return "Angular"
			case .ankh: return "Ankh"
			case .appStore: return "App Store"
			case .appStoreIos: return "iOS App Store"
			case .apper: return "Apper Systems AB"
			case .apple: return "Apple"
			case .appleAlt: return "Fruit Apple"
			case .applePay: return "Apple Pay"
			case .archive: return "Archive"
			case .archway: return "Archway"
			case .arrowAltCircleDown: return "Alternate Arrow Circle Down"
			case .arrowAltCircleLeft: return "Alternate Arrow Circle Left"
			case .arrowAltCircleRight: return "Alternate Arrow Circle Right"
			case .arrowAltCircleUp: return "Alternate Arrow Circle Up"
			case .arrowCircleDown: return "Arrow Circle Down"
			case .arrowCircleLeft: return "Arrow Circle Left"
			case .arrowCircleRight: return "Arrow Circle Right"
			case .arrowCircleUp: return "Arrow Circle Up"
			case .arrowDown: return "arrow-down"
			case .arrowLeft: return "arrow-left"
			case .arrowRight: return "arrow-right"
			case .arrowUp: return "arrow-up"
			case .arrowsAlt: return "Alternate Arrows"
			case .arrowsAltH: return "Alternate Arrows Horizontal"
			case .arrowsAltV: return "Alternate Arrows Vertical"
			case .artstation: return "Artstation"
			case .assistiveListeningSystems: return "Assistive Listening Systems"
			case .asterisk: return "asterisk"
			case .asymmetrik: return "Asymmetrik, Ltd."
			case .at: return "At"
			...
			case .babyCarriage: return "Baby Carriage"
			case .backspace: return "Backspace"
			case .backward: return "backward"
			case .bacon: return "Bacon"
			case .bahai: return "Bahá'í"
			case .balanceScale: return "Balance Scale"
			case .balanceScaleLeft: return "Balance Scale (Left-Weighted)"
			case .balanceScaleRight: return "Balance Scale (Right-Weighted)"
			case .ban: return "ban"
			case .bandAid: return "Band-Aid"
			case .bandcamp: return "Bandcamp"
			case .barcode: return "barcode"
			case .bars: return "Bars"
			case .baseballBall: return "Baseball Ball"
			case .basketballBall: return "Basketball Ball"
			case .bath: return "Bath"
			case .batteryEmpty: return "Battery Empty"
			case .batteryFull: return "Battery Full"
			case .batteryHalf: return "Battery 1/2 Full"
			case .batteryQuarter: return "Battery 1/4 Full"
			case .batteryThreeQuarters: return "Battery 3/4 Full"
			case .battleNet: return "Battle.net"
			case .bed: return "Bed"
			case .beer: return "beer"
			case .behance: return "Behance"
			case .behanceSquare: return "Behance Square"
			case .bell: return "bell"
			case .bellSlash: return "Bell Slash"
			case .bezierCurve: return "Bezier Curve"
			...
			case .blackTie: return "Font Awesome Black Tie"
			case .blackberry: return "BlackBerry"
			case .blender: return "Blender"
			case .blenderPhone: return "Blender Phone"
			case .blind: return "Blind"
			case .blog: return "Blog"
			case .blogger: return "Blogger"
			case .bloggerB: return "Blogger B"
			case .bluetooth: return "Bluetooth"
			case .bluetoothB: return "Bluetooth"
			...
			case .bookDead: return "Book of the Dead"
			case .bookMedical: return "Medical Book"
			case .bookOpen: return "Book Open"
			case .bookReader: return "Book Reader"
			case .bookmark: return "bookmark"
			case .bootstrap: return "Bootstrap"
			case .borderAll: return "Border All"
			case .borderNone: return "Border None"
			case .borderStyle: return "Border Style"
			case .bowlingBall: return "Bowling Ball"
			case .box: return "Box"
			case .boxOpen: return "Box Open"
			case .boxTissue: return "Tissue Box"
			case .boxes: return "Boxes"
			case .braille: return "Braille"
			case .brain: return "Brain"
			case .breadSlice: return "Bread Slice"
			case .briefcase: return "Briefcase"
			case .briefcaseMedical: return "Medical Briefcase"
			...
			case .buromobelexperte: return "Büromöbel-Experte GmbH & Co. KG."
			case .bus: return "Bus"
			case .busAlt: return "Bus Alt"
			case .businessTime: return "Business Time"
			case .buyNLarge: return "Buy n Large"
			case .buysellads: return "BuySellAds"
			case .calculator: return "Calculator"
			case .calendar: return "Calendar"
			case .calendarAlt: return "Alternate Calendar"
			case .calendarCheck: return "Calendar Check"
			case .calendarDay: return "Calendar with Day Focus"
			case .calendarMinus: return "Calendar Minus"
			case .calendarPlus: return "Calendar Plus"
			case .calendarTimes: return "Calendar Times"
			case .calendarWeek: return "Calendar with Week Focus"
			case .camera: return "camera"
			case .cameraRetro: return "Retro Camera"
			case .campground: return "Campground"
			case .canadianMapleLeaf: return "Canadian Maple Leaf"
			case .candyCane: return "Candy Cane"
			case .cannabis: return "Cannabis"
			case .capsules: return "Capsules"
			case .car: return "Car"
			case .carAlt: return "Alternate Car"
			case .carBattery: return "Car Battery"
			case .carCrash: return "Car Crash"
			case .carSide: return "Car Side"
			...
			case .caretSquareDown: return "Caret Square Down"
			case .caretSquareLeft: return "Caret Square Left"
			case .caretSquareRight: return "Caret Square Right"
			case .caretSquareUp: return "Caret Square Up"
			case .caretUp: return "Caret Up"
			case .carrot: return "Carrot"
			case .cartArrowDown: return "Shopping Cart Arrow Down"
			case .cartPlus: return "Add to Shopping Cart"
			case .cashRegister: return "Cash Register"
			case .cat: return "Cat"
			case .ccAmazonPay: return "Amazon Pay Credit Card"
			case .ccAmex: return "American Express Credit Card"
			case .ccApplePay: return "Apple Pay Credit Card"
			case .ccDinersClub: return "Diner's Club Credit Card"
			case .ccDiscover: return "Discover Credit Card"
			case .ccJcb: return "JCB Credit Card"
			case .ccMastercard: return "MasterCard Credit Card"
			case .ccPaypal: return "Paypal Credit Card"
			case .ccStripe: return "Stripe Credit Card"
			case .ccVisa: return "Visa Credit Card"
			case .centercode: return "Centercode"
			case .centos: return "Centos"
			case .certificate: return "certificate"
			case .chair: return "Chair"
			case .chalkboard: return "Chalkboard"
			case .chalkboardTeacher: return "Chalkboard Teacher"
			case .chargingStation: return "Charging Station"
			case .chartArea: return "Area Chart"
			case .chartBar: return "Bar Chart"
			case .chartLine: return "Line Chart"
			case .chartPie: return "Pie Chart"
			case .check: return "Check"
			case .checkCircle: return "Check Circle"
			case .checkDouble: return "Double Check"
			case .checkSquare: return "Check Square"
			case .cheese: return "Cheese"
			case .chess: return "Chess"
			case .chessBishop: return "Chess Bishop"
			case .chessBoard: return "Chess Board"
			case .chessKing: return "Chess King"
			case .chessKnight: return "Chess Knight"
			case .chessPawn: return "Chess Pawn"
			case .chessQueen: return "Chess Queen"
			case .chessRook: return "Chess Rook"
			case .chevronCircleDown: return "Chevron Circle Down"
			case .chevronCircleLeft: return "Chevron Circle Left"
			case .chevronCircleRight: return "Chevron Circle Right"
			case .chevronCircleUp: return "Chevron Circle Up"
			...
			case .circleNotch: return "Circle Notched"
			case .city: return "City"
			case .clinicMedical: return "Medical Clinic"
			case .clipboard: return "Clipboard"
			case .clipboardCheck: return "Clipboard with Check"
			case .clipboardList: return "Clipboard List"
			case .clock: return "Clock"
			case .clone: return "Clone"
			case .closedCaptioning: return "Closed Captioning"
			case .cloud: return "Cloud"
			case .cloudDownloadAlt: return "Alternate Cloud Download"
			case .cloudMeatball: return "Cloud with (a chance of) Meatball"
			case .cloudMoon: return "Cloud with Moon"
			case .cloudMoonRain: return "Cloud with Moon and Rain"
			case .cloudRain: return "Cloud with Rain"
			case .cloudShowersHeavy: return "Cloud with Heavy Showers"
			case .cloudSun: return "Cloud with Sun"
			case .cloudSunRain: return "Cloud with Sun and Rain"
			case .cloudUploadAlt: return "Alternate Cloud Upload"
			case .cloudscale: return "cloudscale.ch"
			case .cloudsmith: return "Cloudsmith"
			case .cloudversify: return "cloudversify"
			case .cocktail: return "Cocktail"
			case .code: return "Code"
			case .codeBranch: return "Code Branch"
			case .codepen: return "Codepen"
			case .codiepie: return "Codie Pie"
			...
			case .commentAlt: return "Alternate Comment"
			case .commentDollar: return "Comment Dollar"
			case .commentDots: return "Comment Dots"
			case .commentMedical: return "Alternate Medical Chat"
			case .commentSlash: return "Comment Slash"
			case .comments: return "comments"
			case .commentsDollar: return "Comments Dollar"
			case .compactDisc: return "Compact Disc"
			case .compass: return "Compass"
			case .compress: return "Compress"
			case .compressAlt: return "Alternate Compress"
			case .compressArrowsAlt: return "Alternate Compress Arrows"
			case .conciergeBell: return "Concierge Bell"
			case .confluence: return "Confluence"
			case .connectdevelop: return "Connect Develop"
			case .contao: return "Contao"
			case .cookie: return "Cookie"
			case .cookieBite: return "Cookie Bite"
			case .copy: return "Copy"
			case .copyright: return "Copyright"
			case .cottonBureau: return "Cotton Bureau"
			case .couch: return "Couch"
			case .cpanel: return "cPanel"
			case .creativeCommons: return "Creative Commons"
			case .creativeCommonsBy: return "Creative Commons Attribution"
			case .creativeCommonsNc: return "Creative Commons Noncommercial"
			case .creativeCommonsNcEu: return "Creative Commons Noncommercial (Euro Sign)"
			case .creativeCommonsNcJp: return "Creative Commons Noncommercial (Yen Sign)"
			case .creativeCommonsNd: return "Creative Commons No Derivative Works"
			case .creativeCommonsPd: return "Creative Commons Public Domain"
			case .creativeCommonsPdAlt: return "Alternate Creative Commons Public Domain"
			case .creativeCommonsRemix: return "Creative Commons Remix"
			case .creativeCommonsSa: return "Creative Commons Share Alike"
			case .creativeCommonsSampling: return "Creative Commons Sampling"
			case .creativeCommonsSamplingPlus: return "Creative Commons Sampling +"
			case .creativeCommonsShare: return "Creative Commons Share"
			case .creativeCommonsZero: return "Creative Commons CC0"
			case .creditCard: return "Credit Card"
			case .criticalRole: return "Critical Role"
			case .crop: return "crop"
			case .cropAlt: return "Alternate Crop"
			case .cross: return "Cross"
			case .crosshairs: return "Crosshairs"
			case .crow: return "Crow"
			case .crown: return "Crown"
			case .crutch: return "Crutch"
			case .css3: return "CSS 3 Logo"
			case .css3Alt: return "Alternate CSS3 Logo"
			case .cube: return "Cube"
			case .cubes: return "Cubes"
			case .cut: return "Cut"
			case .cuttlefish: return "Cuttlefish"
			case .dAndD: return "Dungeons & Dragons"
			case .dAndDBeyond: return "D&D Beyond"
			...
			case .deploydog: return "deploy.dog"
			...
			case .diceD20: return "Dice D20"
			case .diceD6: return "Dice D6"
			case .diceFive: return "Dice Five"
			case .diceFour: return "Dice Four"
			case .diceOne: return "Dice One"
			case .diceSix: return "Dice Six"
			case .diceThree: return "Dice Three"
			case .diceTwo: return "Dice Two"
			case .digg: return "Digg Logo"
			case .digitalOcean: return "Digital Ocean"
			case .digitalTachograph: return "Digital Tachograph"
			...
			case .dollyFlatbed: return "Dolly Flatbed"
			case .donate: return "Donate"
			case .doorClosed: return "Door Closed"
			case .doorOpen: return "Door Open"
			case .dotCircle: return "Dot Circle"
			case .dove: return "Dove"
			case .download: return "Download"
			case .draft2digital: return "Draft2digital"
			case .draftingCompass: return "Drafting Compass"
			case .dragon: return "Dragon"
			case .drawPolygon: return "Draw Polygon"
			case .dribbble: return "Dribbble"
			case .dribbbleSquare: return "Dribbble Square"
			case .dropbox: return "Dropbox"
			case .drum: return "Drum"
			case .drumSteelpan: return "Drum Steelpan"
			case .drumstickBite: return "Drumstick with Bite Taken Out"
			case .drupal: return "Drupal Logo"
			case .dumbbell: return "Dumbbell"
			case .dumpster: return "Dumpster"
			case .dumpsterFire: return "Dumpster Fire"
			case .dungeon: return "Dungeon"
			case .dyalog: return "Dyalog"
			case .earlybirds: return "Earlybirds"
			case .ebay: return "eBay"
			case .edge: return "Edge Browser"
			case .edit: return "Edit"
			case .egg: return "Egg"
			case .eject: return "eject"
			case .elementor: return "Elementor"
			case .ellipsisH: return "Horizontal Ellipsis"
			case .ellipsisV: return "Vertical Ellipsis"
			case .ello: return "Ello"
			case .ember: return "Ember"
			case .empire: return "Galactic Empire"
			case .envelope: return "Envelope"
			case .envelopeOpen: return "Envelope Open"
			case .envelopeOpenText: return "Envelope Open-text"
			case .envelopeSquare: return "Envelope Square"
			case .envira: return "Envira Gallery"
			...
			case .euroSign: return "Euro Sign"
			case .evernote: return "Evernote"
			case .exchangeAlt: return "Alternate Exchange"
			case .exclamation: return "exclamation"
			case .exclamationCircle: return "Exclamation Circle"
			case .exclamationTriangle: return "Exclamation Triangle"
			case .expand: return "Expand"
			case .expandAlt: return "Alternate Expand"
			case .expandArrowsAlt: return "Alternate Expand Arrows"
			case .expeditedssl: return "ExpeditedSSL"
			case .externalLinkAlt: return "Alternate External Link"
			case .externalLinkSquareAlt: return "Alternate External Link Square"
			case .eye: return "Eye"
			case .eyeDropper: return "Eye Dropper"
			case .eyeSlash: return "Eye Slash"
			case .facebook: return "Facebook"
			case .facebookF: return "Facebook F"
			case .facebookMessenger: return "Facebook Messenger"
			case .facebookSquare: return "Facebook Square"
			case .fan: return "Fan"
			case .fantasyFlightGames: return "Fantasy Flight-games"
			case .fastBackward: return "fast-backward"
			case .fastForward: return "fast-forward"
			case .faucet: return "Faucet"
			case .fax: return "Fax"
			case .feather: return "Feather"
			case .featherAlt: return "Alternate Feather"
			...
			case .fileAlt: return "Alternate File"
			case .fileArchive: return "Archive File"
			case .fileAudio: return "Audio File"
			case .fileCode: return "Code File"
			case .fileContract: return "File Contract"
			case .fileCsv: return "File CSV"
			case .fileDownload: return "File Download"
			case .fileExcel: return "Excel File"
			case .fileExport: return "File Export"
			case .fileImage: return "Image File"
			case .fileImport: return "File Import"
			case .fileInvoice: return "File Invoice"
			case .fileInvoiceDollar: return "File Invoice with US Dollar"
			case .fileMedical: return "Medical File"
			case .fileMedicalAlt: return "Alternate Medical File"
			case .filePdf: return "PDF File"
			case .filePowerpoint: return "Powerpoint File"
			case .filePrescription: return "File Prescription"
			case .fileSignature: return "File Signature"
			case .fileUpload: return "File Upload"
			case .fileVideo: return "Video File"
			case .fileWord: return "Word File"
			case .fill: return "Fill"
			case .fillDrip: return "Fill Drip"
			case .film: return "Film"
			case .filter: return "Filter"
			case .fingerprint: return "Fingerprint"
			case .fire: return "fire"
			case .fireAlt: return "Alternate Fire"
			case .fireExtinguisher: return "fire-extinguisher"
			case .firefox: return "Firefox"
			case .firefoxBrowser: return "Firefox Browser"
			case .firstAid: return "First Aid"
			case .firstOrder: return "First Order"
			case .firstOrderAlt: return "Alternate First Order"
			case .firstdraft: return "firstdraft"
			case .fish: return "Fish"
			case .fistRaised: return "Raised Fist"
			case .flag: return "flag"
			case .flagCheckered: return "flag-checkered"
			case .flagUsa: return "United States of America Flag"
			...
			case .folderMinus: return "Folder Minus"
			case .folderOpen: return "Folder Open"
			case .folderPlus: return "Folder Plus"
			case .font: return "font"
			case .fontAwesome: return "Font Awesome"
			case .fontAwesomeAlt: return "Alternate Font Awesome"
			case .fontAwesomeFlag: return "Font Awesome Flag"
			case .fontAwesomeLogoFull: return "Font Awesome Full Logo"
			case .fonticons: return "Fonticons"
			case .fonticonsFi: return "Fonticons Fi"
			case .footballBall: return "Football Ball"
			case .fortAwesome: return "Fort Awesome"
			case .fortAwesomeAlt: return "Alternate Fort Awesome"
			...
			case .frown: return "Frowning Face"
			case .frownOpen: return "Frowning Face With Open Mouth"
			case .fulcrum: return "Fulcrum"
			case .funnelDollar: return "Funnel Dollar"
			case .futbol: return "Futbol"
			case .galacticRepublic: return "Galactic Republic"
			case .galacticSenate: return "Galactic Senate"
			case .gamepad: return "Gamepad"
			case .gasPump: return "Gas Pump"
			case .gavel: return "Gavel"
			case .gem: return "Gem"
			case .genderless: return "Genderless"
			case .getPocket: return "Get Pocket"
			case .gg: return "GG Currency"
			case .ggCircle: return "GG Currency Circle"
			case .ghost: return "Ghost"
			case .gift: return "gift"
			case .gifts: return "Gifts"
			case .git: return "Git"
			case .gitAlt: return "Git Alt"
			case .gitSquare: return "Git Square"
			case .github: return "GitHub"
			case .githubAlt: return "Alternate GitHub"
			case .githubSquare: return "GitHub Square"
			case .gitkraken: return "GitKraken"
			case .gitlab: return "GitLab"
			case .gitter: return "Gitter"
			case .glassCheers: return "Glass Cheers"
			case .glassMartini: return "Martini Glass"
			case .glassMartiniAlt: return "Alternate Glass Martini"
			case .glassWhiskey: return "Glass Whiskey"
			case .glasses: return "Glasses"
			case .glide: return "Glide"
			case .glideG: return "Glide G"
			case .globe: return "Globe"
			case .globeAfrica: return "Globe with Africa shown"
			case .globeAmericas: return "Globe with Americas shown"
			case .globeAsia: return "Globe with Asia shown"
			case .globeEurope: return "Globe with Europe shown"
			case .gofore: return "Gofore"
			case .golfBall: return "Golf Ball"
			case .goodreads: return "Goodreads"
			case .goodreadsG: return "Goodreads G"
			case .google: return "Google Logo"
			case .googleDrive: return "Google Drive"
			case .googlePlay: return "Google Play"
			case .googlePlus: return "Google Plus"
			case .googlePlusG: return "Google Plus G"
			case .googlePlusSquare: return "Google Plus Square"
			case .googleWallet: return "Google Wallet"
			case .gopuram: return "Gopuram"
			case .graduationCap: return "Graduation Cap"
			case .gratipay: return "Gratipay (Gittip)"
			case .grav: return "Grav"
			case .greaterThan: return "Greater Than"
			case .greaterThanEqual: return "Greater Than Equal To"
			case .grimace: return "Grimacing Face"
			case .grin: return "Grinning Face"
			case .grinAlt: return "Alternate Grinning Face"
			case .grinBeam: return "Grinning Face With Smiling Eyes"
			case .grinBeamSweat: return "Grinning Face With Sweat"
			case .grinHearts: return "Smiling Face With Heart-Eyes"
			case .grinSquint: return "Grinning Squinting Face"
			case .grinSquintTears: return "Rolling on the Floor Laughing"
			case .grinStars: return "Star-Struck"
			case .grinTears: return "Face With Tears of Joy"
			case .grinTongue: return "Face With Tongue"
			case .grinTongueSquint: return "Squinting Face With Tongue"
			case .grinTongueWink: return "Winking Face With Tongue"
			case .grinWink: return "Grinning Winking Face"
			case .gripHorizontal: return "Grip Horizontal"
			case .gripLines: return "Grip Lines"
			case .gripLinesVertical: return "Grip Lines Vertical"
			case .gripVertical: return "Grip Vertical"
			case .gripfire: return "Gripfire, Inc."
			case .grunt: return "Grunt"
			case .guitar: return "Guitar"
			case .gulp: return "Gulp"
			case .hSquare: return "H Square"
			case .hackerNews: return "Hacker News"
			case .hackerNewsSquare: return "Hacker News Square"
			case .hackerrank: return "Hackerrank"
			case .hamburger: return "Hamburger"
			case .hammer: return "Hammer"
			case .hamsa: return "Hamsa"
			case .handHolding: return "Hand Holding"
			case .handHoldingHeart: return "Hand Holding Heart"
			case .handHoldingMedical: return "Hand Holding Medical Cross"
			case .handHoldingUsd: return "Hand Holding US Dollar"
			case .handHoldingWater: return "Hand Holding Water"
			case .handLizard: return "Lizard (Hand)"
			case .handMiddleFinger: return "Hand with Middle Finger Raised"
			case .handPaper: return "Paper (Hand)"
			case .handPeace: return "Peace (Hand)"
			case .handPointDown: return "Hand Pointing Down"
			case .handPointLeft: return "Hand Pointing Left"
			case .handPointRight: return "Hand Pointing Right"
			case .handPointUp: return "Hand Pointing Up"
			case .handPointer: return "Pointer (Hand)"
			case .handRock: return "Rock (Hand)"
			case .handScissors: return "Scissors (Hand)"
			case .handSparkles: return "Hand Sparkles"
			case .handSpock: return "Spock (Hand)"
			case .hands: return "Hands"
			case .handsHelping: return "Helping Hands"
			case .handsWash: return "Hands Wash"
			case .handshake: return "Handshake"
			case .handshakeAltSlash: return "Handshake Alternate Slash"
			case .handshakeSlash: return "Handshake Slash"
			case .hanukiah: return "Hanukiah"
			case .hardHat: return "Hard Hat"
			case .hashtag: return "Hashtag"
			case .hatCowboy: return "Cowboy Hat"
			case .hatCowboySide: return "Cowboy Hat Side"
			case .hatWizard: return "Wizard's Hat"
			case .hdd: return "HDD"
			case .headSideCough: return "Head Side Cough"
			case .headSideCoughSlash: return "Head Side-cough-slash"
			case .headSideMask: return "Head Side Mask"
			case .headSideVirus: return "Head Side Virus"
			case .heading: return "heading"
			case .headphones: return "headphones"
			case .headphonesAlt: return "Alternate Headphones"
			case .headset: return "Headset"
			case .heart: return "Heart"
			case .heartBroken: return "Heart Broken"
			...
			case .hockeyPuck: return "Hockey Puck"
			case .hollyBerry: return "Holly Berry"
			case .home: return "home"
			case .hooli: return "Hooli"
			case .hornbill: return "Hornbill"
			case .horse: return "Horse"
			case .horseHead: return "Horse Head"
			case .hospital: return "hospital"
			case .hospitalAlt: return "Alternate Hospital"
			case .hospitalSymbol: return "Hospital Symbol"
			case .hospitalUser: return "Hospital with User"
			case .hotTub: return "Hot Tub"
			case .hotdog: return "Hot Dog"
			case .hotel: return "Hotel"
			case .hotjar: return "Hotjar"
			case .hourglass: return "Hourglass"
			case .hourglassEnd: return "Hourglass End"
			case .hourglassHalf: return "Hourglass Half"
			case .hourglassStart: return "Hourglass Start"
			case .houseDamage: return "Damaged House"
			case .houseUser: return "House User"
			case .houzz: return "Houzz"
			case .hryvnia: return "Hryvnia"
			case .html5: return "HTML 5 Logo"
			case .hubspot: return "HubSpot"
			case .iCursor: return "I Beam Cursor"
			case .iceCream: return "Ice Cream"
			case .icicles: return "Icicles"
			case .icons: return "Icons"
			case .idBadge: return "Identification Badge"
			case .idCard: return "Identification Card"
			case .idCardAlt: return "Alternate Identification Card"
			...
			case .itunesNote: return "Itunes Note"
			case .java: return "Java"
			case .jedi: return "Jedi"
			case .jediOrder: return "Jedi Order"
			case .jenkins: return "Jenkis"
			case .jira: return "Jira"
			case .joget: return "Joget"
			case .joint: return "Joint"
			case .joomla: return "Joomla Logo"
			case .journalWhills: return "Journal of the Whills"
			case .js: return "JavaScript (JS)"
			case .jsSquare: return "JavaScript (JS) Square"
			...
			case .kickstarterK: return "Kickstarter K"
			case .kiss: return "Kissing Face"
			case .kissBeam: return "Kissing Face With Smiling Eyes"
			case .kissWinkHeart: return "Face Blowing a Kiss"
			case .kiwiBird: return "Kiwi Bird"
			case .korvue: return "KORVUE"
			case .landmark: return "Landmark"
			case .language: return "Language"
			case .laptop: return "Laptop"
			case .laptopCode: return "Laptop Code"
			case .laptopHouse: return "Laptop House"
			case .laptopMedical: return "Laptop Medical"
			case .laravel: return "Laravel"
			case .lastfm: return "last.fm"
			case .lastfmSquare: return "last.fm Square"
			case .laugh: return "Grinning Face With Big Eyes"
			case .laughBeam: return "Laugh Face with Beaming Eyes"
			case .laughSquint: return "Laughing Squinting Face"
			case .laughWink: return "Laughing Winking Face"
			case .layerGroup: return "Layer Group"
			case .leaf: return "leaf"
			case .leanpub: return "Leanpub"
			case .lemon: return "Lemon"
			case .less: return "Less"
			case .lessThan: return "Less Than"
			case .lessThanEqual: return "Less Than Equal To"
			case .levelDownAlt: return "Alternate Level Down"
			case .levelUpAlt: return "Alternate Level Up"
			case .lifeRing: return "Life Ring"
			case .lightbulb: return "Lightbulb"
			case .line: return "Line"
			case .link: return "Link"
			case .linkedin: return "LinkedIn"
			case .linkedinIn: return "LinkedIn In"
			case .linode: return "Linode"
			case .linux: return "Linux"
			case .liraSign: return "Turkish Lira Sign"
			case .list: return "List"
			case .listAlt: return "Alternate List"
			case .listOl: return "list-ol"
			case .listUl: return "list-ul"
			case .locationArrow: return "location-arrow"
			case .lock: return "lock"
			case .lockOpen: return "Lock Open"
			case .longArrowAltDown: return "Alternate Long Arrow Down"
			case .longArrowAltLeft: return "Alternate Long Arrow Left"
			case .longArrowAltRight: return "Alternate Long Arrow Right"
			case .longArrowAltUp: return "Alternate Long Arrow Up"
			case .lowVision: return "Low Vision"
			case .luggageCart: return "Luggage Cart"
			case .lungs: return "Lungs"
			case .lungsVirus: return "Lungs Virus"
			case .lyft: return "lyft"
			case .magento: return "Magento"
			case .magic: return "magic"
			case .magnet: return "magnet"
			case .mailBulk: return "Mail Bulk"
			case .mailchimp: return "Mailchimp"
			case .male: return "Male"
			case .mandalorian: return "Mandalorian"
			case .map: return "Map"
			case .mapMarked: return "Map Marked"
			case .mapMarkedAlt: return "Alternate Map Marked"
			case .mapMarker: return "map-marker"
			case .mapMarkerAlt: return "Alternate Map Marker"
			case .mapPin: return "Map Pin"
			case .mapSigns: return "Map Signs"
			case .markdown: return "Markdown"
			case .marker: return "Marker"
			case .mars: return "Mars"
			case .marsDouble: return "Mars Double"
			case .marsStroke: return "Mars Stroke"
			case .marsStrokeH: return "Mars Stroke Horizontal"
			case .marsStrokeV: return "Mars Stroke Vertical"
			case .mask: return "Mask"
			case .mastodon: return "Mastodon"
			case .maxcdn: return "MaxCDN"
			case .mdb: return "Material Design for Bootstrap"
			case .medal: return "Medal"
			case .medapps: return "MedApps"
			case .medium: return "Medium"
			case .mediumM: return "Medium M"
			case .medkit: return "medkit"
			case .medrt: return "MRT"
			case .meetup: return "Meetup"
			case .megaport: return "Megaport"
			case .meh: return "Neutral Face"
			case .mehBlank: return "Face Without Mouth"
			case .mehRollingEyes: return "Face With Rolling Eyes"
			case .memory: return "Memory"
			case .mendeley: return "Mendeley"
			case .menorah: return "Menorah"
			case .mercury: return "Mercury"
			case .meteor: return "Meteor"
			case .microblog: return "Micro.blog"
			case .microchip: return "Microchip"
			case .microphone: return "microphone"
			case .microphoneAlt: return "Alternate Microphone"
			case .microphoneAltSlash: return "Alternate Microphone Slash"
			case .microphoneSlash: return "Microphone Slash"
			...
			case .mobileAlt: return "Alternate Mobile"
			case .modx: return "MODX"
			case .monero: return "Monero"
			case .moneyBill: return "Money Bill"
			case .moneyBillAlt: return "Alternate Money Bill"
			case .moneyBillWave: return "Wavy Money Bill"
			case .moneyBillWaveAlt: return "Alternate Wavy Money Bill"
			case .moneyCheck: return "Money Check"
			case .moneyCheckAlt: return "Alternate Money Check"
			case .monument: return "Monument"
			case .moon: return "Moon"
			case .mortarPestle: return "Mortar Pestle"
			case .mosque: return "Mosque"
			case .motorcycle: return "Motorcycle"
			case .mountain: return "Mountain"
			case .mouse: return "Mouse"
			case .mousePointer: return "Mouse Pointer"
			case .mugHot: return "Mug Hot"
			case .music: return "Music"
			case .napster: return "Napster"
			case .neos: return "Neos"
			case .networkWired: return "Wired Network"
			case .neuter: return "Neuter"
			case .newspaper: return "Newspaper"
			case .nimblr: return "Nimblr"
			case .node: return "Node.js"
			case .nodeJs: return "Node.js JS"
			case .notEqual: return "Not Equal"
			case .notesMedical: return "Medical Notes"
			case .npm: return "npm"
			case .ns8: return "NS8"
			case .nutritionix: return "Nutritionix"
			case .objectGroup: return "Object Group"
			case .objectUngroup: return "Object Ungroup"
			case .odnoklassniki: return "Odnoklassniki"
			case .odnoklassnikiSquare: return "Odnoklassniki Square"
			case .oilCan: return "Oil Can"
			case .oldRepublic: return "Old Republic"
			case .om: return "Om"
			case .opencart: return "OpenCart"
			case .openid: return "OpenID"
			case .opera: return "Opera"
			case .optinMonster: return "Optin Monster"
			case .orcid: return "ORCID"
			case .osi: return "Open Source Initiative"
			case .otter: return "Otter"
			case .outdent: return "Outdent"
			case .page4: return "page4 Corporation"
			case .pagelines: return "Pagelines"
			case .pager: return "Pager"
			case .paintBrush: return "Paint Brush"
			case .paintRoller: return "Paint Roller"
			case .palette: return "Palette"
			case .palfed: return "Palfed"
			case .pallet: return "Pallet"
			case .paperPlane: return "Paper Plane"
			case .paperclip: return "Paperclip"
			case .parachuteBox: return "Parachute Box"
			...
			case .pen: return "Pen"
			case .penAlt: return "Alternate Pen"
			case .penFancy: return "Pen Fancy"
			case .penNib: return "Pen Nib"
			case .penSquare: return "Pen Square"
			case .pencilAlt: return "Alternate Pencil"
			case .pencilRuler: return "Pencil Ruler"
			case .pennyArcade: return "Penny Arcade"
			case .peopleArrows: return "People Arrows"
			case .peopleCarry: return "People Carry"
			case .pepperHot: return "Hot Pepper"
			case .percent: return "Percent"
			case .percentage: return "Percentage"
			case .periscope: return "Periscope"
			case .personBooth: return "Person Entering Booth"
			case .phabricator: return "Phabricator"
			case .phoenixFramework: return "Phoenix Framework"
			case .phoenixSquadron: return "Phoenix Squadron"
			case .phone: return "Phone"
			case .phoneAlt: return "Alternate Phone"
			case .phoneSlash: return "Phone Slash"
			case .phoneSquare: return "Phone Square"
			case .phoneSquareAlt: return "Alternate Phone Square"
			case .phoneVolume: return "Phone Volume"
			case .photoVideo: return "Photo Video"
			case .php: return "PHP"
			case .piedPiper: return "Pied Piper Logo"
			case .piedPiperAlt: return "Alternate Pied Piper Logo (Old)"
			case .piedPiperHat: return "Pied Piper Hat (Old)"
			case .piedPiperPp: return "Pied Piper PP Logo (Old)"
			case .piedPiperSquare: return "Pied Piper Square Logo (Old)"
			case .piggyBank: return "Piggy Bank"
			case .pills: return "Pills"
			case .pinterest: return "Pinterest"
			case .pinterestP: return "Pinterest P"
			case .pinterestSquare: return "Pinterest Square"
			case .pizzaSlice: return "Pizza Slice"
			case .placeOfWorship: return "Place of Worship"
			case .plane: return "plane"
			case .planeArrival: return "Plane Arrival"
			case .planeDeparture: return "Plane Departure"
			case .planeSlash: return "Plane Slash"
			...
			case .pollH: return "Poll H"
			case .poo: return "Poo"
			case .pooStorm: return "Poo Storm"
			case .poop: return "Poop"
			case .portrait: return "Portrait"
			case .poundSign: return "Pound Sign"
			case .powerOff: return "Power Off"
			case .pray: return "Pray"
			case .prayingHands: return "Praying Hands"
			case .prescription: return "Prescription"
			case .prescriptionBottle: return "Prescription Bottle"
			case .prescriptionBottleAlt: return "Alternate Prescription Bottle"
			case .print: return "print"
			case .procedures: return "Procedures"
			case .productHunt: return "Product Hunt"
			case .projectDiagram: return "Project Diagram"
			case .pumpMedical: return "Pump Medical"
			case .pumpSoap: return "Pump Soap"
			...
			case .questionCircle: return "Question Circle"
			...
			case .rProject: return "R Project"
			case .radiation: return "Radiation"
			case .radiationAlt: return "Alternate Radiation"
			...
			case .recordVinyl: return "Record Vinyl"
			case .recycle: return "Recycle"
			case .redRiver: return "red river"
			case .reddit: return "reddit Logo"
			case .redditAlien: return "reddit Alien"
			case .redditSquare: return "reddit Square"
			case .redhat: return "Redhat"
			case .redo: return "Redo"
			case .redoAlt: return "Alternate Redo"
			case .registered: return "Registered Trademark"
			case .removeFormat: return "Remove Format"
			...
			case .rss: return "rss"
			case .rssSquare: return "RSS Square"
			case .rubleSign: return "Ruble Sign"
			case .ruler: return "Ruler"
			case .rulerCombined: return "Ruler Combined"
			case .rulerHorizontal: return "Ruler Horizontal"
			case .rulerVertical: return "Ruler Vertical"
			case .running: return "Running"
			case .rupeeSign: return "Indian Rupee Sign"
			case .sadCry: return "Crying Face"
			case .sadTear: return "Loudly Crying Face"
			case .safari: return "Safari"
			case .salesforce: return "Salesforce"
			case .sass: return "Sass"
			case .satellite: return "Satellite"
			case .satelliteDish: return "Satellite Dish"
			...
			case .searchDollar: return "Search Dollar"
			case .searchLocation: return "Search Location"
			case .searchMinus: return "Search Minus"
			case .searchPlus: return "Search Plus"
			...
			case .shareAlt: return "Alternate Share"
			case .shareAltSquare: return "Alternate Share Square"
			case .shareSquare: return "Share Square"
			case .shekelSign: return "Shekel Sign"
			case .shieldAlt: return "Alternate Shield"
			case .shieldVirus: return "Shield Virus"
			case .ship: return "Ship"
			case .shippingFast: return "Shipping Fast"
			case .shirtsinbulk: return "Shirts in Bulk"
			case .shoePrints: return "Shoe Prints"
			case .shopify: return "Shopify"
			case .shoppingBag: return "Shopping Bag"
			case .shoppingBasket: return "Shopping Basket"
			case .shoppingCart: return "shopping-cart"
			case .shopware: return "Shopware"
			case .shower: return "Shower"
			case .shuttleVan: return "Shuttle Van"
			case .sign: return "Sign"
			case .signInAlt: return "Alternate Sign In"
			case .signLanguage: return "Sign Language"
			case .signOutAlt: return "Alternate Sign Out"
			...
			case .skiingNordic: return "Skiing Nordic"
			case .skull: return "Skull"
			case .skullCrossbones: return "Skull & Crossbones"
			case .skyatlas: return "skyatlas"
			case .skype: return "Skype"
			case .slack: return "Slack Logo"
			case .slackHash: return "Slack Hashtag"
			case .slash: return "Slash"
			case .sleigh: return "Sleigh"
			case .slidersH: return "Horizontal Sliders"
			case .slideshare: return "Slideshare"
			case .smile: return "Smiling Face"
			case .smileBeam: return "Beaming Face With Smiling Eyes"
			case .smileWink: return "Winking Face"
			case .smog: return "Smog"
			case .smoking: return "Smoking"
			case .smokingBan: return "Smoking Ban"
			case .sms: return "SMS"
			case .snapchat: return "Snapchat"
			case .snapchatGhost: return "Snapchat Ghost"
			case .snapchatSquare: return "Snapchat Square"
			...
			case .sortAlphaDown: return "Sort Alphabetical Down"
			case .sortAlphaDownAlt: return "Alternate Sort Alphabetical Down"
			case .sortAlphaUp: return "Sort Alphabetical Up"
			case .sortAlphaUpAlt: return "Alternate Sort Alphabetical Up"
			case .sortAmountDown: return "Sort Amount Down"
			case .sortAmountDownAlt: return "Alternate Sort Amount Down"
			case .sortAmountUp: return "Sort Amount Up"
			case .sortAmountUpAlt: return "Alternate Sort Amount Up"
			case .sortDown: return "Sort Down (Descending)"
			case .sortNumericDown: return "Sort Numeric Down"
			case .sortNumericDownAlt: return "Alternate Sort Numeric Down"
			case .sortNumericUp: return "Sort Numeric Up"
			case .sortNumericUpAlt: return "Alternate Sort Numeric Up"
			case .sortUp: return "Sort Up (Ascending)"
			case .soundcloud: return "SoundCloud"
			case .sourcetree: return "Sourcetree"
			case .spa: return "Spa"
			case .spaceShuttle: return "Space Shuttle"
			case .speakap: return "Speakap"
			case .speakerDeck: return "Speaker Deck"
			case .spellCheck: return "Spell Check"
			case .spider: return "Spider"
			case .spinner: return "Spinner"
			case .splotch: return "Splotch"
			case .spotify: return "Spotify"
			case .sprayCan: return "Spray Can"
			case .square: return "Square"
			case .squareFull: return "Square Full"
			case .squareRootAlt: return "Alternate Square Root"
			case .squarespace: return "Squarespace"
			case .stackExchange: return "Stack Exchange"
			...
			case .starHalfAlt: return "Alternate Star Half"
			case .starOfDavid: return "Star of David"
			case .starOfLife: return "Star of Life"
			case .staylinked: return "StayLinked"
			case .steam: return "Steam"
			case .steamSquare: return "Steam Square"
			case .steamSymbol: return "Steam Symbol"
			case .stepBackward: return "step-backward"
			case .stepForward: return "step-forward"
			case .stethoscope: return "Stethoscope"
			case .stickerMule: return "Sticker Mule"
			case .stickyNote: return "Sticky Note"
			case .stop: return "stop"
			case .stopCircle: return "Stop Circle"
			case .stopwatch: return "Stopwatch"
			case .stopwatch20: return "Stopwatch 20"
			case .store: return "Store"
			case .storeAlt: return "Alternate Store"
			case .storeAltSlash: return "Alternate Store Slash"
			case .storeSlash: return "Store Slash"
			case .strava: return "Strava"
			case .stream: return "Stream"
			case .streetView: return "Street View"
			case .strikethrough: return "Strikethrough"
			case .stripe: return "Stripe"
			case .stripeS: return "Stripe S"
			case .stroopwafel: return "Stroopwafel"
			case .studiovinari: return "Studio Vinari"
			case .stumbleupon: return "StumbleUpon Logo"
			case .stumbleuponCircle: return "StumbleUpon Circle"
			case .`subscript`: return "subscript"
			case .subway: return "Subway"
			case .suitcase: return "Suitcase"
			case .suitcaseRolling: return "Suitcase Rolling"
			case .sun: return "Sun"
			case .superpowers: return "Superpowers"
			case .superscript: return "superscript"
			case .supple: return "Supple"
			case .surprise: return "Hushed Face"
			...
			case .syncAlt: return "Alternate Sync"
			case .syringe: return "Syringe"
			case .table: return "table"
			case .tableTennis: return "Table Tennis"
			case .tablet: return "tablet"
			case .tabletAlt: return "Alternate Tablet"
			case .tablets: return "Tablets"
			case .tachometerAlt: return "Alternate Tachometer"
			case .tag: return "tag"
			...
			case .teethOpen: return "Teeth Open"
			case .telegram: return "Telegram"
			case .telegramPlane: return "Telegram Plane"
			...
			case .theRedYeti: return "The Red Yeti"
			case .theaterMasks: return "Theater Masks"
			case .themeco: return "Themeco"
			case .themeisle: return "ThemeIsle"
			case .thermometer: return "Thermometer"
			case .thermometerEmpty: return "Thermometer Empty"
			case .thermometerFull: return "Thermometer Full"
			case .thermometerHalf: return "Thermometer 1/2 Full"
			case .thermometerQuarter: return "Thermometer 1/4 Full"
			case .thermometerThreeQuarters: return "Thermometer 3/4 Full"
			case .thinkPeaks: return "Think Peaks"
			case .thumbsDown: return "thumbs-down"
			case .thumbsUp: return "thumbs-up"
			case .thumbtack: return "Thumbtack"
			case .ticketAlt: return "Alternate Ticket"
			case .times: return "Times"
			case .timesCircle: return "Times Circle"
			case .tint: return "tint"
			case .tintSlash: return "Tint Slash"
			case .tired: return "Tired Face"
			case .toggleOff: return "Toggle Off"
			case .toggleOn: return "Toggle On"
			case .toilet: return "Toilet"
			case .toiletPaper: return "Toilet Paper"
			case .toiletPaperSlash: return "Toilet Paper Slash"
			...
			case .tradeFederation: return "Trade Federation"
			...
			case .transgenderAlt: return "Alternate Transgender"
			case .trash: return "Trash"
			case .trashAlt: return "Alternate Trash"
			case .trashRestore: return "Trash Restore"
			case .trashRestoreAlt: return "Alternative Trash Restore"
			...
			case .truckMonster: return "Truck Monster"
			case .truckMoving: return "Truck Moving"
			case .truckPickup: return "Truck Side"
			case .tshirt: return "T-Shirt"
			case .tty: return "TTY"
			case .tumblr: return "Tumblr"
			case .tumblrSquare: return "Tumblr Square"
			case .tv: return "Television"
			case .twitch: return "Twitch"
			case .twitter: return "Twitter"
			case .twitterSquare: return "Twitter Square"
			case .typo3: return "Typo3"
			case .uber: return "Uber"
			case .ubuntu: return "Ubuntu"
			case .uikit: return "UIkit"
			case .umbraco: return "Umbraco"
			case .umbrella: return "Umbrella"
			case .umbrellaBeach: return "Umbrella Beach"
			case .underline: return "Underline"
			case .undo: return "Undo"
			case .undoAlt: return "Alternate Undo"
			case .uniregistry: return "Uniregistry"
			case .unity: return "Unity 3D"
			case .universalAccess: return "Universal Access"
			case .university: return "University"
			case .unlink: return "unlink"
			case .unlock: return "unlock"
			case .unlockAlt: return "Alternate Unlock"
			case .untappd: return "Untappd"
			case .upload: return "Upload"
			case .ups: return "UPS"
			case .usb: return "USB"
			case .user: return "User"
			case .userAlt: return "Alternate User"
			case .userAltSlash: return "Alternate User Slash"
			case .userAstronaut: return "User Astronaut"
			case .userCheck: return "User Check"
			case .userCircle: return "User Circle"
			case .userClock: return "User Clock"
			case .userCog: return "User Cog"
			case .userEdit: return "User Edit"
			case .userFriends: return "User Friends"
			case .userGraduate: return "User Graduate"
			case .userInjured: return "User Injured"
			case .userLock: return "User Lock"
			case .userMd: return "Doctor"
			case .userMinus: return "User Minus"
			case .userNinja: return "User Ninja"
			case .userNurse: return "Nurse"
			case .userPlus: return "User Plus"
			case .userSecret: return "User Secret"
			case .userShield: return "User Shield"
			case .userSlash: return "User Slash"
			case .userTag: return "User Tag"
			case .userTie: return "User Tie"
			case .userTimes: return "Remove User"
			case .users: return "Users"
			case .usersCog: return "Users Cog"
			case .usps: return "United States Postal Service"
			case .ussunnah: return "us-Sunnah Foundation"
			case .utensilSpoon: return "Utensil Spoon"
			case .utensils: return "Utensils"
			case .vaadin: return "Vaadin"
			case .vectorSquare: return "Vector Square"
			case .venus: return "Venus"
			case .venusDouble: return "Venus Double"
			case .venusMars: return "Venus Mars"
			case .viacoin: return "Viacoin"
			case .viadeo: return "Video"
			case .viadeoSquare: return "Video Square"
			...
			case .vimeoSquare: return "Vimeo Square"
			case .vimeoV: return "Vimeo"
			case .vine: return "Vine"
			case .virus: return "Virus"
			case .virusSlash: return "Virus Slash"
			case .viruses: return "Viruses"
			case .vk: return "VK"
			case .vnv: return "VNV"
			case .voicemail: return "Voicemail"
			case .volleyballBall: return "Volleyball Ball"
			case .volumeDown: return "Volume Down"
			case .volumeMute: return "Volume Mute"
			case .volumeOff: return "Volume Off"
			case .volumeUp: return "Volume Up"
			case .voteYea: return "Vote Yea"
			case .vrCardboard: return "Cardboard VR"
			case .vuejs: return "Vue.js"
			case .walking: return "Walking"
			case .wallet: return "Wallet"
			case .warehouse: return "Warehouse"
			case .water: return "Water"
			case .waveSquare: return "Square Wave"
			case .waze: return "Waze"
			case .weebly: return "Weebly"
			case .weibo: return "Weibo"
			case .weight: return "Weight"
			case .weightHanging: return "Hanging Weight"
			case .weixin: return "Weixin (WeChat)"
			case .whatsapp: return "What's App"
			case .whatsappSquare: return "What's App Square"
			case .wheelchair: return "Wheelchair"
			case .whmcs: return "WHMCS"
			case .wifi: return "WiFi"
			case .wikipediaW: return "Wikipedia W"
			case .wind: return "Wind"
			case .windowClose: return "Window Close"
			...
			case .wineGlassAlt: return "Alternate Wine Glas"
			case .wix: return "Wix"
			case .wizardsOfTheCoast: return "Wizards of the Coast"
			case .wolfPackBattalion: return "Wolf Pack Battalion"
			case .wonSign: return "Won Sign"
			case .wordpress: return "WordPress Logo"
			case .wordpressSimple: return "Wordpress Simple"
			...
			case .xingSquare: return "Xing Square"
			case .yCombinator: return "Y Combinator"
			case .yahoo: return "Yahoo Logo"
			case .yammer: return "Yammer"
			case .yandex: return "Yandex"
			case .yandexInternational: return "Yandex International"
			case .yarn: return "Yarn"
			case .yelp: return "Yelp"
			case .yenSign: return "Yen Sign"
			case .yinYang: return "Yin Yang"
			case .yoast: return "Yoast"
			case .youtube: return "YouTube"
			case .youtubeSquare: return "YouTube Square"
